---
title: "MILKQUA project: milk and udder-swab samples - Metabarcoding Stats"
...
joined_pairs <- read.csv("/home/mycelium/milkqua_project/qiime_1.9_results/results/readsPerSample",sep="\t",header = FALSE,skip = 1, stringsAsFactors = FALSE)
...
inputSeqs <- read.table("/home/mycelium/milkqua_project/qiime_1.9_results/results/inputSeqs",sep=":")
outputSeqs <- read.table("/home/mycelium/milkqua_project/qiime_1.9_results/results/outputSeqs", sep="\t")
samples <- read.table("/home/mycelium/milkqua_project/qiime_1.9_results/results/samples.txt", sep=":")
