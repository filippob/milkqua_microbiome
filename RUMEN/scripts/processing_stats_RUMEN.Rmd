...
inputSeqs <- read.table("/home/oem/Results/RUMEN/results/inputSeqs",sep=":")
outputSeqs <- read.table("/home/oem/Results/RUMEN/results/outputSeqs", sep="\t")
samples_rum <- read.table("/home/oem/Results/RUMEN/results/samples.txt", sep=":")
...
```{r, echo=FALSE}
mapfile_rumen<- fread("/home/oem/Results/RUMEN/mapping_file_rumen.csv", header = TRUE)
