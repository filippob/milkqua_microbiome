...
otu <- fread("../../../rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L2.txt", header = TRUE, skip = 1)
...
otu2 <- fread("../../../rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L2.txt", header = TRUE, skip = 1)
otu3 <- fread("../../../rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L3.txt", header = TRUE, skip = 1)
otu4 <- fread("../../../rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L4.txt", header = TRUE, skip = 1)
otu5 <- fread("../../../rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L5.txt", header = TRUE, skip = 1)
otu6 <- fread("../../../rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L6.txt", header = TRUE, skip = 1)
...
fwrite(temp, file = "../../../results/rumen_significant_otus.csv", col.names = TRUE, sep = ",")
print (dd)
```
...
dd <- filter(D1, treatment == "AE1") %>% mutate(variable = "p-value")
