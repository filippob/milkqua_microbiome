...
otu <- fread(file.path(project_folder, "rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L2.txt"), header = TRUE, skip = 1)
...
otu2 <- fread(file.path(project_folder,"rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L2.txt"), header = TRUE, skip = 1)
otu3 <- fread(file.path(project_folder,"rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L3.txt"), header = TRUE, skip = 1)
otu4 <- fread(file.path(project_folder,"rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L4.txt"), header = TRUE, skip = 1)
otu5 <- fread(file.path(project_folder,"rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L5.txt"), header = TRUE, skip = 1)
otu6 <- fread(file.path(project_folder,"rumen/qiime_1.9/results/taxa_summary_abs/CSS_normalized_otu_table_L6.txt"), header = TRUE, skip = 1)
...
dd <- spread(D0, key = treatment, value = avg_counts)
temp <- inner_join(DX,dd, by = c("level" = "level", "new_taxa" = "new_taxa"))
fwrite(temp, file = file.path(project_folder, "rumen/rumen_significant_otus_pre.csv"), col.names = TRUE, sep = ",")
print (dd)
```
