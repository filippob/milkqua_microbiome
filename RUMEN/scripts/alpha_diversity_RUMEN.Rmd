...
```{r alpha, echo=FALSE}
metadata <- fread("~/Documents/MILKQUA/rumen/mapping_file.csv")
...
alpha <- read.table("~/Documents/MILKQUA/rumen/qiime_1.9/results/alpha_diversity/alpha.txt", header = TRUE)
