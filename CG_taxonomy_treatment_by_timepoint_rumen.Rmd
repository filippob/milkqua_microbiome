...
print(p)
ggsave(p, height = 20, width = 10, filename ="taxonomy_phylum_piechart_milk.png")
...
<!-- print(p) -->
<!-- ggsave(p, height = 20, width = 4, filename ="taxonomy_phylum_boxplot_milk.png") -->
...
# p <- p + scale_fill_manual(values = my_palette)
print(p)
ggsave(p, height = 16, width = 4, filename ="taxonomy_phylum_barplot_milk.png")
...
ggsave ("taxonomy_bubbleplot_milk.png")
```
