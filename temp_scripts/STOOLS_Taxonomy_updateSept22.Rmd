...
print(pgeneratot)
ggsave(pgeneratot, height = 5, width = 15, filename ="~/Results/STOOLS/results/core_genera_stools.png")
# 
...
D$timepoint <- factor(D$timepoint, levels=c("2"))
...
Pgenera <- Pgenera + facet_grid(timepoint~treatment)
...
print(Pgenera)
ggsave(Pgenera, height = 5, width = 10, filename ="~/Results/STOOLS/results/taxonomy_genus_boxplot_stools_tot_T2.png")
...
fg <- fg + coord_flip()
fg <- fg + xlab("Behaviour") + ylab("Genera")
...
dragon
ggsave(filename = "~/Results/STOOLS/results/taxonomy_heat+barplot_stools.png", plot = dragon, device = "png", width = 5, height = 3)
```
