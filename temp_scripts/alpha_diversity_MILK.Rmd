...
alpha <- read.table("/home/mycelium/Results/MILK_SKINSWAB/results/alpha_diversity/alpha.txt", header = TRUE)
...
ggsave(filename = "~/Results/MILK_SKINSWAB/results/alpha_MILK.png", plot = figure_finalA, device = "png", width = 15, height = 5)
```