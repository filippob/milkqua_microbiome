...
project_folder = "/home/oem/Results/SKINSWABS"
...
=======
  do(tidy(lm(corrected_counts ~ timepoint+treatment, data = .))) %>%
>>>>>>> bb23097b16d254e40e641429d514714b0d8c3065
  filter(term != "(Intercept)")
...
=======
    ctrl_t1 <- sum(sum(t1>0) == 3, min(t1) > 3) == 3
    t2 = pull(tbl,T2)
    ctrl_t2 <-  sum(sum(t2>0) == 3, min(t2) > 3) == 3
>>>>>>> bb23097b16d254e40e641429d514714b0d8c3065
...
#write.csv(res, "~/Results/SKINSWABS/results/Bootstrap_res_Observed.csv")
