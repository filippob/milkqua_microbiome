...
p
#ggsave(filename = "~/Results/SKINSWABS/results/alpha_significance_tablewithdots_SKINSWABS.png", width = 7, height = 7, plot = p, device = "png")
```
...
mD$timepoint <- factor(mD$timepoint, levels=c("before_oil", "after_oil", "8"))
...
ggsave(filename = "~/Results/SKINSWABS/results/alpha_significance_tablewithdots_correctedforbaseline_Skinswabs.png", width = 6, height = 6, plot = p, device = "png")
```
