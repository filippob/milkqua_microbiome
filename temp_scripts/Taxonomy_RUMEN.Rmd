...
pfamily <- pfamily + theme(text = element_text(size=10),
               ...
               legend.title=element_text(size=10))
print(pfamily)
#ggsave(pfamily, height = 8, width = 16, filename ="taxonomy_family_bargraph_rumen.png")
...
porder <- porder + geom_label_repel(aes(label = paste0(avg_abund*100, "%")), position=position_stack (vjust=0.5), size=4, show.legend = F)
