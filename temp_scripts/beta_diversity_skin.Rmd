...
p2 <- autoplot(prcomp(1-matx0), data=mat_skinswab_1, colour = "treatment", label = TRUE, label.size = 3, frame = TRUE, frame.type='norm')
p2
#ggsave("clustering_by_treatment_PCA_skinswab_T28.png")
```
...
p2 <- autoplot(prcomp(1-matx0), data=mat_skinswab_1, colour = "treatment", label = TRUE, label.size = 3, frame = TRUE, frame.type='norm')
p2
#ggsave("clustering_by_treatment_PCA_skinswab_T21.png")
```
...
p2 <- autoplot(prcomp(1-matx0), data=mat_skinswab_1, colour = "treatment", label = TRUE, label.size = 3, frame = TRUE, frame.type='norm')
p2
#ggsave("clustering_by_treatment_PCA_skinswab_T8.png")
```
