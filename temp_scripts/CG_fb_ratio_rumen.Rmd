...
ggsave(filename = "fb_ratio_milk.png", plot = p, device = "png")
```
...
kable(D)
fwrite(D, file = "fb_ratio_milk.csv")
```
...
ggsave(filename = "fb_ratio_bootstrap_milk.png", plot = p, device = "png")
```
