...
`
```{r}
tot <- ggarrange(p, px, widths=c(1, 0.5), heights=c(1, 1),  labels=c("A", "B"), nrow=1, ncol=2)
print(tot)

ggsave(filename = "~/Results/Milkqua_skinswab_bootstrapping/results/alpha_Bootstrap_2_10000replicates_7indices.png", width = 15, height = 5, plot = tot, device = "png")
```
