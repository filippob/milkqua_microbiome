...
D$timepoint <- factor(D$timepoint, levels=c( "45 days", "13 months")) #CHANGE HERE
...
FF <- ggarrange(q, fg, widths=c(0.5,1), heights=c(1,1), labels = c("A","B","C","D"), legend = "bottom")
print(FF)
ggsave(filename = "~/Results/STOOLS/results/taxonomy_stools.png", plot = FF, device = "png", width = 20, height = 10)
```
