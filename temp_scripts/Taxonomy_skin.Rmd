...
p <- p + facet_wrap(treatment~timepoint)
...
my_palette = get_palette(c("green3","gold","blue","magenta","cyan","yellow","red","gray","purple","brown", "darkorange1","pink1", "darkorchid1", "seagreen2"), length(unique(x$Phylum)))
...
#ggsave(filename = file.path(basedir, prjdir, outdir, "taxonomy_Phylum_piechart_skinswabs_wbaseline.png"), plot = p, device = "png", width = 7, height = 5)
```
